...
sequenceDiagram
    ...
    staffInfoCtrl->>+TygzController:findGc07ById{id:agc070}
    TygzController->>+DB:select * from GC07 where agc070 = ?
    DB-->>-TygzController:GC07实体
    TygzController-->>-staffInfoCtrl:GC07DTO 用于修改弹出框回显
