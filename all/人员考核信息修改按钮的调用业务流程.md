...
sequenceDiagram
    ...
    staffInfoCtrl->>+TygzController:findGc21Hc26ById{id:agc210}
    TygzController->>+DB:select * from GC21_NOAPPLY where agc210 = ?
    DB-->>-TygzController:返回GC21_NOAPPLY实体
    TygzController-->>-TygzController:GC21_NOAPPLY=>GC21_NOAPPLYDTO
    TygzController-->>-staffInfoCtrl:返回GC21_NOAPPLYDTO 返回修改前，选中的考核信息 用于页面回显
