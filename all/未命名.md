...
sequenceDiagram
    ...
    TygzController->>+TygzController:GC07DTO中主键agc040不为空
    ...
    TygzController->>+DB:更新简历信息 update GC04 set ...
    ...
    TygzController->>+DB:select * from GC04 where 1=1 and agc010 = ? and aae100 = '1' order by aae030 asc,aae031 nulls last,agc072 asc 
